...
using SubscriptionService.Infrastructure.Messaging.Producers;
...
builder.Services.AddScoped<ISubscriptionService, SubscriptionService.Application.Services.SubscriptionService>();

builder.Services.AddSingleton<IEventPublisher, KafkaProducerService>();

builder.Services.AddAutoMapper(typeof(SubscriptionMapperProfile).Assembly);
