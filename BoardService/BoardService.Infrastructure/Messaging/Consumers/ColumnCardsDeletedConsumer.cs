...
public class ColumnCardsDeletedConsumer : BackgroundService
{
    ...
    public ColumnCardsDeletedConsumer(IServiceScopeFactory scopeFactory, IOptions<KafkaSettings> options)
    {
        ...
        _topic = _kafkaSettings.DeletedColumnTopic;
    }
    ...
    protected override async Task ExecuteAsync(CancellationToken stoppingToken)
    {
        ...
        while (!stoppingToken.IsCancellationRequested)
        {
            ...
            if (evt != null)
            {
                ...
                await boardService.CompleteColumnDeletionAsync(evt.ColumnId);
            }
        }
    }
