...
public class BoardCardsDeleteFailedConsumer : BackgroundService
{
    ...
    public BoardCardsDeleteFailedConsumer(IServiceScopeFactory scopeFactory, IOptions<KafkaSettings> options)
    {
        ...
        _topic = _kafkaSettings.DeleteFailedTopic;
    }
    ...
    protected override async Task ExecuteAsync(CancellationToken stoppingToken)
    {
        ...
        while (!stoppingToken.IsCancellationRequested)
        {
            ...
            var evt = JsonSerializer.Deserialize<BoardCardsDeletedEvent>(cr.Message.Value);
            ...
            if (evt != null)
            {
                ...
                await boardService.FailedBoardDeleteAsync(evt.BoardId);
            }
        }
    }
