...
public class BoardCardsDeletedConsumer : BackgroundService
{
    ...
    public BoardCardsDeletedConsumer(IServiceScopeFactory scopeFactory, IOptions<KafkaSettings> options)
    {
        ...
        _topic = _kafkaSettings.DeletedTopic;
    }
    ...
    protected override async Task ExecuteAsync(CancellationToken stoppingToken)
    {
        ...
        while (!stoppingToken.IsCancellationRequested)
        {
            ...
            if (evt != null)
            {
                ...
                await boardService.CompleteBoardDeletionAsync(evt.BoardId);
            }
        }
    }
