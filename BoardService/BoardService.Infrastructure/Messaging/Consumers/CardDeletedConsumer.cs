...
public class CardDeletedConsumer : BackgroundService
{
    ...
    public CardDeletedConsumer(IServiceScopeFactory scopeFactory, IOptions<KafkaSettings> options)
    {
        ...
        _topic = _kafkaSettings.CardDeletedTopic;
    }
    ...
    protected override async Task ExecuteAsync(CancellationToken stoppingToken)
    {
        ...
        while (!stoppingToken.IsCancellationRequested)
        {
            ...
            var message = JsonSerializer.Deserialize<CardDeletedEvent>(cr.Message.Value);
            ...
            if (message != null)
            {
                ...
                await service.DeleteCardPositionAsync(message.CardId);
            }
        }
    }
