...
public class ColumnDeleteConsumer: BackgroundService
{
    ...
    public ColumnDeleteConsumer(IServiceScopeFactory scopeFactory, IOptions<KafkaSettings> options)
    {
        ...
        _topic = _kafkaSettings.DeleteColumnTopic;
    }
    ...
    protected override async Task ExecuteAsync(CancellationToken stoppingToken)
    {
        ...
        while (!stoppingToken.IsCancellationRequested)
        {
            ...
            var message = JsonSerializer.Deserialize<ColumnDeleteEvent>(cr.Message.Value);
            ...
            if (message != null)
            {
                ...
                var deleteRequest = new DeleteColumnCardsRequest()
                {
                    Cards = message.CardIds,
                    ColumnId = message.ColumnId
                };
                await service.DeleteColumnCardsAsync(deleteRequest);
            }
        }
    }
